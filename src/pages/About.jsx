...
import StatsComponenet from "../../../../GIt_Pull/g_1/src/components/core/AboutPage/Stats"
...
const About = () => {
  return (
    <div className="bg-richblack-900 min-h-screen">
      ...
      {/* Section 5 */}
      <section className="mx-auto mt-20 flex full max-w-maxContent flex-col justify-between gap-10 text-white">
        <LearningGrid />
        <ContactFormSection />
      </section>
